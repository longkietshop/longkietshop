...
$productsPerRow = $this->category->products_per_row;
if (!$productsPerRow)
...
if (count($this->products))
{
	...
	<div id="products-list-container" class="products-list-container block list">
		<div class="sortPagiBar row-fluid clearfix">
            ...
            <div class="span9">
                <form method="post" name="adminForm" id="adminForm" action="<?php echo JRoute::_(EshopRoute::getCategoryRoute($this->category->id)); ?>">
					<div class="clearfix">
			...
			<div class="clearfix">
                ...
                foreach ($this->products as $product)
                {
					...
					<div class="span<?php echo $span; ?> ajax_block_product spanbox clearfix">
                        <div class="img_block">                            
                            <a href="<?php echo JRoute::_(EshopRoute::getProductRoute($product->id, $this->category->id)); ?>">
