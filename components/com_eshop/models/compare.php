...
class EShopModelCompare extends EShopModel
{
	...
	function add($productId)
	{
		...
		if (is_object($productInfo))
		{
			...
			$message = '<div style="vertical-align: middle;">' . sprintf(JText::_('ESHOP_ADD_TO_COMPARE_SUCCESS_MESSAGE'), $viewProductLink, $productInfo->product_name, $viewCompareLink) . '</div>';
