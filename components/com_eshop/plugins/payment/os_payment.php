...
class os_payment
{
    ...
    ?>
        ...
        <form action="index.php?option=com_eshop&task=checkout.processOrder" method="post" name="payment_method_form" id="payment_method_form" class="form form-horizontal" onsubmit="return checkPaymentData();">
