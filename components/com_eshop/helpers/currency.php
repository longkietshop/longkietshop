...
class EshopCurrency
{
	 ...
	 */
	public function format($number, $currencyCode = '', $exchangedValue = '', $format = true)
	{
		...
		$numberString .= number_format(round($number, (int)$this->currencies[$code]['decimal_place']), (int)$this->currencies[$code]['decimal_place'], $this->currencies[$code]['decimal_symbol'], $this->currencies[$code]['thousands_separator']);
		if ($format)
