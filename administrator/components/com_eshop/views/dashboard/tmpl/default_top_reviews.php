...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th>
				<?php echo JText::_('ESHOP_NUMBER_REVIEWS'); ?>
			</th>
		</tr>
	</thead>
	<tbody>
		<?php
		if (count($this->topReviewsData))
		{
			for ($i = 0, $n = count($this->topReviewsData); $i < $n; $i++)
			{
				$row = $this->topReviewsData[$i];
