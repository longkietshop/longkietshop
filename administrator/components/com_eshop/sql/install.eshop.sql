...
INSERT INTO `#__eshop_menus` (`id`, `menu_name`, `menu_parent_id`, `menu_view`, `menu_layout`, `published`, `ordering`) VALUES
(1, 'ESHOP_DASHBOARD', 0, 'dashboard', NULL, 1, 1),
(2, 'ESHOP_CATALOG', 0, NULL, NULL, 1, 2),
(3, 'ESHOP_CATEGORIES', 2, 'categories', NULL, 1, 1),
(4, 'ESHOP_PRODUCTS', 2, 'products', NULL, 1, 2),
(5, 'ESHOP_OPTIONS', 2, 'options', NULL, 1, 5),
(6, 'ESHOP_MANUFACTURERS', 2, 'manufacturers', NULL, 1, 6),
(7, 'ESHOP_ORDERS', 8, 'orders', NULL, 1, 1),
(8, 'ESHOP_SALES', 0, NULL, NULL, 1, 4),
(9, 'ESHOP_ATTRIBUTEGROUPS', 2, 'attributegroups', NULL, 1, 4),
(10, 'ESHOP_ATTRIBUTES', 2, 'attributes', NULL, 1, 3),
(11, 'ESHOP_HELP', 0, 'help', NULL, 1, 7),
(12, 'ESHOP_COUPONS', 8, 'coupons', NULL, 1, 4),
(13, 'ESHOP_TAXCLASSES', 15, 'taxclasses', NULL, 1, 10),
(14, 'ESHOP_TAXRATES', 15, 'taxrates', NULL, 1, 11),
(15, 'ESHOP_SYSTEM', 0, '', NULL, 1, 5),
(16, 'ESHOP_COUNTRIES', 15, 'countries', NULL, 1, 2),
(17, 'ESHOP_ZONES', 15, 'zones', NULL, 1, 8),
(18, 'ESHOP_GEOZONES', 15, 'geozones', NULL, 1, 9),
(19, 'ESHOP_CUSTOMERGROUPS', 8, 'customergroups', NULL, 1, 3),
(20, 'ESHOP_CONFIGURATION', 15, 'configuration', NULL, 1, 1),
(21, 'ESHOP_CUSTOMERS', 8, 'customers', NULL, 1, 2),
(22, 'ESHOP_REPORTS', 0, 'reports', NULL, 1, 6),
(23, 'ESHOP_PLUGINS', 0, NULL, NULL, 1, 3),
(24, 'ESHOP_PAYMENTS', 23, 'payments', NULL, 1, 1),
(25, 'ESHOP_SHIPPINGS', 23, 'shippings', NULL, 1, 2),
(26, 'ESHOP_REVIEWS', 2, 'reviews', NULL, 1, 7),
(27, 'ESHOP_CURRENCIES', 15, 'currencies', NULL, 1, 3),
(28, 'ESHOP_STOCKSTATUSES', 15, 'stockstatuses', NULL, 1, 4),
(29, 'ESHOP_ORDERSTATUSES', 15, 'orderstatuses', NULL, 1, 5),
(30, 'ESHOP_LENGTHS', 15, 'lengths', NULL, 1, 6),
(31, 'ESHOP_WEIGHTS', 15, 'weights', NULL, 1, 7),
(32, 'ESHOP_ORDERS', 22, 'reports', 'orders', 1, 1),
(33, 'ESHOP_VIEWED_PRODUCTS', 22, 'reports', 'viewedproducts', 1, 2),
(34, 'ESHOP_PURCHASED_PRODUCTS', 22, 'reports', 'purchasedproducts', 1, 3),
(35, 'ESHOP_THEMES', 23, 'themes', NULL, 1, 3),
(36, 'ESHOP_MESSAGES', 15, 'messages', 'messages', 1, 12),
(37, 'ESHOP_TRANSLATION', 15, 'language', NULL, 1, 13),
(38, 'ESHOP_EXPORTS', 15, 'exports', NULL, 1, 14);
...
CREATE TABLE IF NOT EXISTS `#__eshop_orders` (
  ...
  `shipping_company_id` varchar(32) DEFAULT NULL,
